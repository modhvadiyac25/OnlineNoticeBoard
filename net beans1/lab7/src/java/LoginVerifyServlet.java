...
public class LoginVerifyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String username="zzz",password="zzz",uname ="chetan";
            ...
            if(request.getParameter("uname").equals(username) && request.getParameter("password").equals(password))
            {
                ...
                s.setAttribute("chetan",uname);
                String temp=(String) s.getAttribute(uname);
                out.println(temp);
                out.println("<br>Welcome "+ uname);
                out.println("<br><a href='first.jsp'>Fisrt.jsp</a>");
