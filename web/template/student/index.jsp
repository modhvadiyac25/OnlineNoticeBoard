<%-- 
    Document   : index
    Created on : 14 Mar, 2020, 1:57:58 AM
    Author     : modhv
--%>
...
<head>
    ...
    <!-- The above 4 meta tags *m   ust* come first in the head; any other head content must come *after* these tags -->
    <!-- Title -->
                        ...
                        <div class="col-12">
                            <div class="hero-slides-content">
                              <!--  <h4 data-animation="fadeInUp" data-delay="100ms">All the courses you need</h4> -->
                                <h2 data-animation="fadeInUp" data-delay="400ms">Wellcome to our <br>Online Notice Board</h2>
